...
public class EmploymentDaoHibernate extends PartyRelationshipDaoHibernate
	...
	public Employment findByClient( Integer clientId ) {
		...
		try {
			String queryString = "select new list(empm) " + "FROM Employment AS empm "
									+ "WHERE empm.client.uniqueId = :clientId";
