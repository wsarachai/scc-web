...
<div>
    ...
    <div>
        <ul>
          ...
          <ktm:else>
            <ktm:iterate name="bean" property="formCollection" id="article">
              <li>
                <div>${id}. ${article.title} ${article.dateCreated}
                  <input type="button" value="${ktm:getText('page.btn.edit')}" onclick="goTo('CRUDArticle?method=edit&uniqueId=${article.uniqueId}')">
                  <input type="button" value="${ktm:getText('page.btn.delete')}" onclick="goToConfirm('CRUDArticle?method=del&uniqueId=${article.uniqueId}')">
                </div>
              </li>
            </ktm:iterate>
            </ktm:else>
        ...
        <p>
            <input type="button" value="add" onclick="goTo('CRUDArticle?method=new')">
            <input type="button" value="home" onclick="goTo('index')">
        </p>
    </div>
</div>
<div id="dialog-confirm" title='${ktm:getText("page.confirm.delete")} ${ktm:getText("page.article.title")} ?'>
